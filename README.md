...
This dataset is a **large-scale collection of raw Arabic call center audio (dual-channel)**, designed to support the development and training of advanced speech and AI systems.
